        ...
        <>
          ...
          <div className="panel">
            ...
            {pendingTasks.map((task) => (
              <div key={task.id} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '13px 0', borderBottom: '1px solid var(--border-default)' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {task.due_date && (
                    <div style={{ fontSize: 11.5, color: task.due_date < today ? '#EF4444' : 'var(--text-muted)', marginTop: 3 }}>
