...
const features = [
  {
    ...
    desc: "Streamlined process from application to offer letter — most candidates hear back within days, not weeks.",
  },
  {
    title: "Right-Fit Matching",
    desc: "We match skills and ambition to real openings, not just keywords — so the role actually fits your career path.",
  },
  {
    title: "900+ Trusted Clients",
    desc: "From growing startups to industry leaders, our client network spans every major sector in India.",
  },
  {
    title: "Real Growth Paths",
    desc: "Every role comes with a visible career ladder — see exactly how you'll grow, not just where you'll start.",
  },
  {
    title: "Campus to Corporate",
    desc: "Dedicated campus recruitment drives connecting fresh graduates directly with hiring companies.",
  },
  {
    title: "20+ Years Trusted",
    desc: "Since 2002, we've built our reputation on transparency, speed, and genuinely caring about outcomes.",
  },
];
...
const testimonials = [
  {
    quote:
      "Talent Corner placed me within three weeks of graduating. The process felt personal, not transactional.",
    name: "Recent Graduate",
    role: "Software Engineer, Pune",
  },
  {
    quote:
      "As a hiring partner, their shortlists are always relevant. It saves us weeks of screening time.",
    name: "HR Manager",
    role: "Mid-size IT Company",
  },
  {
    quote:
      "They didn't just find me a job — they helped me understand the actual growth path ahead of me.",
    name: "Campus Hire",
...
function MaskLine({ children, delay }) {
  return (
    <span className="mask-line-outer">
      <span className="mask-line-inner" style={{ animationDelay: `${delay}s` }}>
        {children}
      </span>
    </span>
  );
      ...
      >
        ...
        >
          <Reveal style={{ textAlign: "center", marginBottom: 40 }}>
            ...
            >
              Select a department, then scroll through their real climb — entry
              level to leadership.
            </p>
          </Reveal>
        ...
        >
          ...
          >
            © {new Date().getFullYear()} Talent Corner HR Services · Since 2002
    ...
    >
      ...
      >
        <div>
          ...
          >
            Since 2002, Talent Corner has grown from a team of three into one of
            India's leading HR Management companies — serving 900+ clients
            across 15 locations nationwide.
          </p>
...
function BentoStats() {
  return (
    ...
    >
      ...
      >
        <Reveal
          className="panel glass-3d tilt-card"
          style={{
            gridColumn: "span 2",
            gridRow: "span 2",
            display: "flex",
        ...
        >
          ...
          >
            Two decades of building trust between candidates and companies
            across India.
          </p>
        </Reveal>
...
function ScrollAbout() {
  return (
    <section
      id="about"
      style={{
        padding: "40px clamp(20px,4vw,48px) 90px",
        maxWidth: 900,
        margin: "0 auto",
      }}
    >
      <Reveal>
        <span className="chapter-num" style={{ fontSize: 60 }}>
          01
        </span>
        ...
        >
          We are a professional human resources organization providing
          innovative recruitment solutions to the corporate world. Our mission
          is to match the right person to the right job with the highest level
          of service — making recruitment easier, faster, and more transparent
          for every candidate and client we work with.
        </p>
      </Reveal>
    </section>
  );
    ...
    >
      <Reveal style={{ marginBottom: 50, maxWidth: 560 }}>
        ...
        <p style={{ fontSize: 14.5, color: "var(--text-muted)" }}>
          Not just another recruitment agency — a partner invested in where you
          actually end up.
        </p>
      </Reveal>
      <div
...
function TestimonialStrip() {
  return (
    <section
      style={{
        padding: "10px clamp(20px,4vw,48px) 100px",
        maxWidth: 1200,
        margin: "0 auto",
      }}
    >
  ...
  return (
    ...
    >
      ...
      <Reveal style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          Ready to Build Your <em style={{ fontStyle: "italic" }}>Career</em>{" "}
          With Us?
        </h2>
        <p
          style={{
        ...
        >
          Whether you're a candidate looking for growth or a company looking for
          talent — let's talk.
        </p>
        <div
          style={{
